    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen p-4 bg-secondary/20">
        <div className="max-w-3xl mx-auto pt-16 animate-fade-in">
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-8">
            <div className="glass p-6 rounded-lg transform hover:scale-105 transition-transform duration-300">
      ...
      <section className="min-h-screen p-4">
        <div className="max-w-3xl mx-auto pt-16 animate-fade-in">
          ...
          <p className="text-center text-muted-foreground">Project showcase coming soon...</p>
        </div>
      </section>
